...
#Indexing #Accessing Values in a file
...
Number1 = eval(input("Enter Number:")) #The eval function automatically evaluates the data type of the value. Here it is a Integer.
...
split.split(",") #This will Split the values of the string with respect to ",".
...
min(tup2) #The min function will give the minimum or lowest element of the tuple.
